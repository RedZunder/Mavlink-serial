...
/* USER CODE BEGIN PV */
	...
	int chan = MAVLINK_COMM_0;							//one data stream only
	uint8_t byte=0x00;
...
void decode_mavlink_mssg(const uint8_t* byte)
{
